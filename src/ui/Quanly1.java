...
//
        ...
        btnTimKiem.getModel().addChangeListener(e -> {
            ButtonModel model = btnTimKiem.getModel();
            if (model.isPressed()) {
        ...
        btnThemNhanVien.getModel().addChangeListener(e -> {
            ButtonModel model = btnThemNhanVien.getModel();
            if (model.isPressed()) {
                btnThemNhanVien.setBackground(Color.PINK);
            } else {
                btnThemNhanVien.setBackground(Color.RED);
            }
        });
        btnThemSanPham.setFocusPainted(false);
        btnThemSanPham.setContentAreaFilled(false);
        btnThemSanPham.setBorderPainted(false);
        btnThemSanPham.setOpaque(true);
        btnThemSanPham.getModel().addChangeListener(e -> {
            ButtonModel model = btnThemSanPham.getModel();
            if (model.isPressed()) {
                btnThemSanPham.setBackground(Color.PINK);
            } else {
                btnThemSanPham.setBackground(Color.RED);
            }
        });
        btnSuaNhanVien.setFocusPainted(false);
        btnSuaNhanVien.setContentAreaFilled(false);
        btnSuaNhanVien.setBorderPainted(false);
        btnSuaNhanVien.setOpaque(true);
        btnSuaNhanVien.getModel().addChangeListener(e -> {
            ButtonModel model = btnSuaNhanVien.getModel();
            if (model.isPressed()) {
                btnSuaNhanVien.setBackground(Color.PINK);
            } else {
                btnSuaNhanVien.setBackground(Color.RED);
            }
        });
        btnSuaSanPham.setFocusPainted(false);
        btnSuaSanPham.setContentAreaFilled(false);
        btnSuaSanPham.setBorderPainted(false);
        btnSuaSanPham.setOpaque(true);
        btnSuaSanPham.getModel().addChangeListener(e -> {
            ButtonModel model = btnSuaSanPham.getModel();
            if (model.isPressed()) {
                btnSuaSanPham.setBackground(Color.PINK);
            } else {
        ...
        btnXoaNhanVien.getModel().addChangeListener(e -> {
            ButtonModel model = btnXoaNhanVien.getModel();
            if (model.isPressed()) {
                btnXoaNhanVien.setBackground(Color.PINK);
            } else {
                btnXoaNhanVien.setBackground(Color.RED);
            }
        });
        btnXoaSanPham.setFocusPainted(false);
        btnXoaSanPham.setContentAreaFilled(false);
        btnXoaSanPham.setBorderPainted(false);
        btnXoaSanPham.setOpaque(true);
        btnXoaSanPham.getModel().addChangeListener(e -> {
            ButtonModel model = btnXoaSanPham.getModel();
            if (model.isPressed()) {
                btnXoaSanPham.setBackground(Color.PINK);
            } else {
...
//
        ...
        ThongKe.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 0, java.awt.Color.BLACK));
        NhanVien.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 0, java.awt.Color.BLACK));
        SanPham.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 0, java.awt.Color.BLACK));
...
//        
        menuLabels = Arrays.asList(lblThongKe, lblNhanVien, lblSanPham, lblBanHang);
//        
    ...
    private void addClickEffect(JLabel lbl, Color normal, Color pressed, Color hover) {
        lbl.setOpaque(true);
        lbl.setBackground(normal);

        lbl.addMouseListener(new java.awt.event.MouseAdapter() {
            @Override
            public void mousePressed(java.awt.event.MouseEvent e) {
                lbl.setBackground(pressed);
            }
    ...
    private void lblThongKeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblThongKeMouseClicked
        ...
        addClickEffect(lblThongKe, Color.RED, Color.PINK, Color.ORANGE);
    ...
    private void lblNhanVienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblNhanVienMouseClicked
        ...
        SanPham.setVisible(false);
        BanHang.setVisible(false);
        addClickEffect(lblNhanVien, Color.RED, Color.PINK, Color.ORANGE);
...
//                );
//
//                JDialog dialog = new JDialog((Frame) null, "Xác nhận đăng xuất", true);
...
////                                        button.setBackground(new Color(200, 0, 0)); // hover
////                                    }
//
//                                    @Override
...
//        });
    ...
    private void lblSanPhamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSanPhamMouseClicked
        ...
        BanHang.setVisible(false);
        addClickEffect(lblSanPham, Color.RED, Color.PINK, Color.ORANGE);
    ...
    private void lblBanHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBanHangMouseClicked
        ...
        addClickEffect(lblBanHang, Color.RED, Color.PINK, Color.ORANGE);
